#loc1 = loc("./in/test.c":54:6)
#loc11 = loc("./in/test.c":58:3)
#loc12 = loc("./in/test.c":55:3)
#loc15 = loc("./in/test.c":59:5)
#loc16 = loc("./in/test.c":56:3)
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-apple-macosx13.0.0", "polygeist.target-cpu" = "penryn", "polygeist.target-features" = "+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @example_locals(%arg0: memref<?xf32> loc("./in/test.c":54:6), %arg1: memref<?xf32> loc("./in/test.c":54:6)) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %1 = memref.load %0[%c0] : memref<1xi32> loc(#loc8)
    ...
    ^bb0(%arg2: f32 loc("./in/test.c":55:3), %arg3: i32 loc("./in/test.c":58:3), %arg4: f32 loc("./in/test.c":58:3)):
      %4 = memref.load %2[%c0] : memref<1xi32> loc(#loc9)
      ...
      ^bb0(%arg5: f32 loc("./in/test.c":56:3), %arg6: f32 loc("./in/test.c":55:3), %arg7: i32 loc("./in/test.c":59:5)):
    ...
    memref.store %3#0, %arg0[%c0] : memref<?xf32> loc(#loc29)
    return loc(#loc30)
  } loc(#loc1)
} loc(#loc0)
#loc0 = loc(unknown)
#loc2 = loc("./in/test.c":59:30)
#loc3 = loc("./in/test.c":62:41)
#loc4 = loc("./in/test.c":58:16)
#loc5 = loc("./in/test.c":56:18)
#loc6 = loc("./in/test.c":55:17)
#loc7 = loc("./in/test.c":59:10)
#loc8 = loc("./in/test.c":58:23)
#loc9 = loc("./in/test.c":59:25)
#loc10 = loc("./in/test.c":58:21)
#loc13 = loc("./in/pom2k_c_header.h":5:43)
#loc14 = loc("./in/test.c":59:23)
#loc17 = loc("./in/pom2k_c_header.h":5:38)
#loc18 = loc("./in/test.c":60:29)
#loc19 = loc("./in/test.c":60:16)
#loc20 = loc("./in/test.c":60:11)
#loc21 = loc("./in/test.c":60:34)
#loc22 = loc("./in/test.c":60:32)
#loc23 = loc("./in/test.c":60:7)
#loc24 = loc("./in/test.c":61:22)
#loc25 = loc("./in/test.c":61:17)
#loc26 = loc("./in/test.c":62:39)
#loc27 = loc("./in/test.c":62:18)
#loc28 = loc("./in/test.c":58:28)
#loc29 = loc("./in/test.c":67:8)
#loc30 = loc("./in/test.c":68:1)
